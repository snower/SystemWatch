...
{
    public class NetworkInterfaceLoader : Window
    {
        ...
        public NetworkInterfaceLoader(Point location, Size clientSize) : base(location, clientSize)
        {
            ...
            Program.GetInformation().SetDataToView(Information.DataType.NetworkInterfaceLoadPercent, this.canvasView, "", new object[] { 1 });
            Program.GetInformation().SetDataToView(Information.DataType.NetworkInterfaceReceivedLoadPercent, this.canvasView, "", new object[] { 2 });
            Program.GetInformation().SetDataToView(Information.DataType.NetworkInterfaceSentLoadPercent, this.canvasView, "", new object[] { 3 });
        }
