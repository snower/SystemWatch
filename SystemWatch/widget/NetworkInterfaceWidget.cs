...
namespace SystemWatch
{
    public class NetworkInterfaceWidget : Widget
    {
        ...
        public NetworkInterfaceWidget(Point location, Size clientSize) : base(location, clientSize)
        {
            ...
            this.sentLoction = new Point(clientSize.Width / 2 + 6, 28);
            this.totalReceivedLocation = new Point(17, 45);
            this.totalSentLocation = new Point(clientSize.Width / 2 + 6, 45); 
            ...
            Program.GetInformation().SetDataToView(Performance.DataType.NetworkInterfaceSentLoadPercent, this.canvasView, "", new object[] { 2 });
            Program.GetInformation().SetDataToView(Performance.DataType.NetworkInterfaceReceivedLoadPercent, this.canvasView, "", new object[] { 3 });
        }
